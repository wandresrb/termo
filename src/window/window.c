...
window_destroy(struct window *w)
{
	...
	/*
	 * Events fired during teardown (pane-resized from window_unzoom,
	 * pane-closed) take and drop references; they must not re-enter here.
	 */
	w->flags |= WINDOW_DESTROYING;
