...
attach_scene() {
	...
	$TERMO respawnp -k "$TERMO2 attach" || exit 1
	sleep 1
}

new_scene() {
	$TERMO2 neww -d "sh -c 'printf \"BIDI-LEFT 12345\nBIDI-RIGHT 67890\"; exec sleep 100'" || exit 1
